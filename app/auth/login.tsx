...
const Login = () => {
  ...
  return (
    <VStack w="$full" h="$full" space="xl" alignItems="center" justifyContent="center">
      <Text bold fontSize="$2xl" size="xl">
        Log In
      </Text>
      ...
      <FormControl w="$1/2" size="md" isInvalid={passwordError != ''}>
        ...
        <FormControlHelper>
          <Button variant="link" size="xs" onPress={() => router.navigate('auth/forgotpassword')}>
      ...
      <Button variant="link" onPress={() => router.navigate('/auth/register')}>
